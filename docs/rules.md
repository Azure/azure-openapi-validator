...
Please refer to [lro-put-provisioning-state-specified.md](./lro-put-provisioning-state-specified) for details.
...
Please refer to [lro-patch-provisioning-state-specified.md](./lro-patch-provisioning-state-specified) for details.
...
Please refer to [lro-delete-provisioning-state-specified.md](./lro-delete-provisioning-state-specified) for details.
