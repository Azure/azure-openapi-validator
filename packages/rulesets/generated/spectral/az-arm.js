...
const avoidMsdnReferences = (swaggerObj, _opts, paths) => {
  ...
  if (typeof swaggerObj === "string" && !swaggerObj.includes("https://msdn.microsoft.com")) return []
  if (typeof swaggerObj === "object") {
    const docUrl = swaggerObj.url
    if (docUrl === undefined || !docUrl.startsWith("https://msdn.microsoft.com")) return []
  }
  const path = paths.path || []
  return [
    {
...
const longRunningOperationsOptionsValidator = (postOp, _opts, ctx) => {
  ...
  if (
    schemaAvailable &&
    ((_b = postOp === null || postOp === void 0 ? void 0 : postOp["x-ms-long-running-operation-options"]) === null || _b === void 0
      ? void 0
      : _b["final-state-via"]) !== "location" &&
    ((_c = postOp === null || postOp === void 0 ? void 0 : postOp["x-ms-long-running-operation-options"]) === null || _c === void 0
      ? void 0
      : _c["final-state-via"]) !== "azure-async-operation"
  ) {
    errors.push({
...
const mutabilityWithReadOnly = (prop, _opts, ctx) => {
  ...
  if (prop.readOnly === undefined || prop["x-ms-mutability"] === undefined || prop["x-ms-mutability"].length === 0) {
    return []
  }
  const path = ctx.path || []
  const errors = []
...
function getGetOperationSchema(paths, ctx) {
  ...
  const getOperation = jsonPath(
    getOperationPath,
    (_a = ctx === null || ctx === void 0 ? void 0 : ctx.documentInventory) === null || _a === void 0 ? void 0 : _a.resolved
  )
  if (!getOperation) {
    return undefined
  }
  return (
    ((_b = getOperation === null || getOperation === void 0 ? void 0 : getOperation.responses["200"]) === null || _b === void 0
      ? void 0
      : _b.schema) ||
    ((_c = getOperation === null || getOperation === void 0 ? void 0 : getOperation.responses["201"]) === null || _c === void 0
      ? void 0
      : _c.schema)
  )
}
...
const nextLinkPropertyMustExist = (opt, _opts, ctx) => {
  ...
  const responseSchemaProperties = getProperties(
    (_c = (_b = opt === null || opt === void 0 ? void 0 : opt.responses) === null || _b === void 0 ? void 0 : _b["200"]) === null ||
      _c === void 0
      ? void 0
      : _c.schema
  )
  if (nextLinkName !== null && nextLinkName !== "") {
    if (Object.keys(responseSchemaProperties).length === 0 || !Object.keys(responseSchemaProperties).includes(nextLinkName)) {
      errors.push({
...
const listInOperationName = (swaggerObj, _opts, paths) => {
  ...
  Object.values(responseList).some((response) => {
    ...
    if (response.schema) {
      if (
        ((_b = (_a = response.schema.properties) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0
          ? void 0
          : _b.type) === "array" &&
        Object.keys(response.schema.properties).length === 1
      ) {
        if (!listRegex.test(swaggerObj["operationId"])) {
          gotArray = true
          return true
...
const lroStatusCodesReturnTypeSchema = (putOp, _opts, ctx) => {
  ...
  for (const responseCode of responseCodes) {
    if (
      (putOp === null || putOp === void 0 ? void 0 : putOp.responses) &&
      (putOp === null || putOp === void 0 ? void 0 : putOp.responses[responseCode])
    ) {
      if (
        !(putOp === null || putOp === void 0 ? void 0 : putOp.responses[responseCode].schema) ||
...
const operationIdNounVerb = (operationId, _opts, ctx) => {
  ...
  const errors = []
  const nounPartOfOperationId = operationId.split("_")[0]
  const nounSearchPattern = nounPartOfOperationId.slice(-1) === "s" ? `${nounPartOfOperationId}?` : `${nounPartOfOperationId}`
...
const consistentPatchProperties = (patchOp, _opts, ctx) => {
  ...
  const patchBodySchema =
    (_b =
      (_a = patchOp === null || patchOp === void 0 ? void 0 : patchOp.parameters) === null || _a === void 0
        ? void 0
        : _a.find((p) => p.in === "body")) === null || _b === void 0
      ? void 0
      : _b.schema
  const patchBodySchemaIndex =
    (_c = patchOp === null || patchOp === void 0 ? void 0 : patchOp.parameters) === null || _c === void 0
      ? void 0
      : _c.findIndex((p) => p.in === "body")
  const responseSchema =
    ((_e = (_d = patchOp === null || patchOp === void 0 ? void 0 : patchOp.responses) === null || _d === void 0 ? void 0 : _d["200"]) ===
      null || _e === void 0
      ? void 0
      : _e.schema) ||
    ((_g = (_f = patchOp === null || patchOp === void 0 ? void 0 : patchOp.responses) === null || _f === void 0 ? void 0 : _f["201"]) ===
      null || _g === void 0
      ? void 0
      : _g.schema) ||
    getGetOperationSchema(path.slice(0, -1), ctx)
...
const longRunningResponseStatusCode = (methodOp, _opts, ctx, validResponseCodesList) => {
  ...
  const operationId =
    ((_a = methodOp === null || methodOp === void 0 ? void 0 : methodOp[method]) === null || _a === void 0 ? void 0 : _a.operationId) || ""
  if (
    !((_b = methodOp === null || methodOp === void 0 ? void 0 : methodOp[method]) === null || _b === void 0
      ? void 0
      : _b["x-ms-long-running-operation"])
  ) {
    return []
  }
  if ((_c = methodOp === null || methodOp === void 0 ? void 0 : methodOp[method]) === null || _c === void 0 ? void 0 : _c.responses) {
    const responseCodes = Object.keys(
      (_d = methodOp === null || methodOp === void 0 ? void 0 : methodOp[method]) === null || _d === void 0 ? void 0 : _d.responses
    )
...
const hasApiVersionParameter = (apiPath, opts, paths) => {
  ...
  for (const method of Object.keys(apiPath)) {
    if (opts.methods.includes(method)) {
      const param =
        (_b = (_a = apiPath[method]) === null || _a === void 0 ? void 0 : _a.parameters) === null || _b === void 0
          ? void 0
          : _b.filter((p) => p.name === apiVersionName)
...
const hasHeader = (response, opts, paths) => {
  ...
  const path = paths.path || []
  const hasHeader = Object.keys(response.headers || {}).some((name) => name.toLowerCase() === opts.name.toLowerCase())
  if (!hasHeader) {
    return [
      {
...
const httpsSupportedScheme = (scheme, _opts, paths) => {
  if (scheme == null || typeof scheme !== "object") return []
  const schemeArray = scheme
  if (schemeArray[0] === "https" && schemeArray.length === 1) return []
  const path = paths.path || []
  return [
    {
...
const locationMustHaveXmsMutability = (scheme, _opts, paths) => {
  ...
  if (scheme["x-ms-mutability"] !== undefined && Array.isArray(scheme["x-ms-mutability"])) {
    ...
    if (schemeArray.includes("create") && schemeArray.includes("read")) return []
  }
  const path = paths.path || []
  return [
    {
...
const lroPatch202 = (patchOp, _opts, ctx) => {
  ...
  const errors = []
  if (
    (patchOp === null || patchOp === void 0 ? void 0 : patchOp.responses) &&
    !(patchOp === null || patchOp === void 0 ? void 0 : patchOp.responses["202"])
  ) {
    errors.push({
...
const securityDefinitionsStructure = (swagger, _opts) => {
  ...
  if (
    ((_a = securityDefinition === null || securityDefinition === void 0 ? void 0 : securityDefinition.azure_auth) === null || _a === void 0
      ? void 0
      : _a.type) === "oauth2" &&
    ((_b = securityDefinition === null || securityDefinition === void 0 ? void 0 : securityDefinition.azure_auth) === null || _b === void 0
      ? void 0
      : _b.authorizationUrl) === "https://login.microsoftonline.com/common/oauth2/authorize" &&
    ((_c = securityDefinition === null || securityDefinition === void 0 ? void 0 : securityDefinition.azure_auth) === null || _c === void 0
      ? void 0
      : _c.flow) === "implicit" &&
    ((_d = securityDefinition === null || securityDefinition === void 0 ? void 0 : securityDefinition.azure_auth) === null || _d === void 0
      ? void 0
      : _d.description) &&
    ((_f =
      (_e = securityDefinition === null || securityDefinition === void 0 ? void 0 : securityDefinition.azure_auth) === null || _e === void 0
        ? void 0
        : _e.scopes) === null || _f === void 0
      ? void 0
      : _f.user_impersonation)
  ) {
    likeModule = true
  }
  if (!likeModule) {
...
const validatePatchBodyParamProperties = createRulesetFunction(
  ...
  (patchOp, _opts, ctx) => {
    ...
    const errors = []
    const bodyParameter =
      (_b = (_a = patchOp.parameters) === null || _a === void 0 ? void 0 : _a.find((p) => p.in === "body")) === null || _b === void 0
        ? void 0
        : _b.schema
    if (bodyParameter) {
      ...
      if (_opts.should) {
        const responseSchema =
          ((_d = (_c = patchOp.responses) === null || _c === void 0 ? void 0 : _c["200"]) === null || _d === void 0 ? void 0 : _d.schema) ||
          ((_f = (_e = patchOp.responses) === null || _e === void 0 ? void 0 : _e["201"]) === null || _f === void 0 ? void 0 : _f.schema) ||
          getGetOperationSchema(path.slice(0, -1), ctx)
        _opts.should.forEach((p) => {
          var _a, _b
          if (
            !((_a = getProperties(bodyParameter)) === null || _a === void 0 ? void 0 : _a[p]) &&
            ((_b = getProperties(responseSchema)) === null || _b === void 0 ? void 0 : _b[p])
          ) {
            errors.push({
