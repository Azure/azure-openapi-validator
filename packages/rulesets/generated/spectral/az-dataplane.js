...
const consistentresponsebody = (pathItem, _opts, paths) => {
  ...
  const path = paths.path || []
  const errors = []
  const createResponseSchema = (op) => {
    var _a, _b
    return (_b = (_a = op === null || op === void 0 ? void 0 : op.responses) === null || _a === void 0 ? void 0 : _a["201"]) === null ||
      _b === void 0
      ? void 0
      : _b.schema
  }
  ...
  if (resourceSchema) {
    ;["put", "get", "patch"].forEach((method) => {
      ...
      const responseSchema =
        (_c =
          (_b = (_a = pathItem[method]) === null || _a === void 0 ? void 0 : _a.responses) === null || _b === void 0
            ? void 0
            : _b["200"]) === null || _c === void 0
          ? void 0
          : _c.schema
...
function validateErrorResponseSchema(errorResponseSchema, pathToSchema) {
  ...
  if (
    !((_b = (_a = errorResponseSchema.required) === null || _a === void 0 ? void 0 : _a.includes) === null || _b === void 0
      ? void 0
      : _b.call(_a, "error"))
  ) {
    errors.push({
  ...
  if (
    ["code", "message"].every((prop) => {
      var _a, _b
      return !((_b = (_a = errorSchema.required) === null || _a === void 0 ? void 0 : _a.includes) === null || _b === void 0
        ? void 0
        : _b.call(_a, prop))
    })
  ) {
...
const paginationResponse = (operation, _opts, paths) => {
  ...
  const resp = Object.keys(operation.responses).find((code) => code.startsWith("2"))
  if (!resp) {
    return []
  }
  ...
  if (operation["x-ms-pageable"]) {
    ...
    const responseHasArray = Object.values(responseSchema.properties || {}).some(
      (prop) => (prop === null || prop === void 0 ? void 0 : prop.type) === "array"
    )
...
const paramOrder = (paths) => {
  ...
  for (const pathKey of Object.keys(paths)) {
    ...
    if (paramsInPath.length > 0) {
      ...
      const pathItemPathParams =
        (_c = (_b = pathItem.parameters) === null || _b === void 0 ? void 0 : _b.filter(inPath).map(paramName)) !== null && _c !== void 0
          ? _c
          : []
      ...
      if (indx >= 0 && indx < paramsInPath.length) {
        ...
        methods
          ...
          .forEach((method) => {
            var _a, _b
            const opPathParams =
              (_b = (_a = pathItem[method].parameters) === null || _a === void 0 ? void 0 : _a.filter(inPath).map(paramName)) !== null &&
              _b !== void 0
                ? _b
                : []
