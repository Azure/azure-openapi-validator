...
test("ProvisioningStateSpecifiedForLROPatch referencing definitions from same swagger should find errors", () => {
  const oasDoc = {
    swagger: "2.0",
    paths: {
      "/foo": {
...
test("ProvisioningStateSpecifiedForRegularPatch should find no errors", () => {
  const oasDoc = {
    swagger: "2.0",
    paths: {
      "/foo": {
