...
class CompositeAzureTests {
  @test public async "description should not be property name"() {
    ...
    const messages: Message[] = await collectTestMessagesFromValidator(fileName, OpenApiTypes.arm, DescriptionMustNotBeNodeName)
  ...
  @test public async "operations returning a model including an array might be pageable (sad path)"() {
    ...
    const messages: Message[] = await collectTestMessagesFromValidator(fileName, OpenApiTypes.arm, PageableOperation)
  ...
  @test public async "extensions x-ms-enum must not have duplicate name"() {
    ...
    const messages: Message[] = await collectTestMessagesFromValidator(fileName, OpenApiTypes.arm, UniqueXmsEnumName)
  ...
  @test public async "new apiVersion have operation without systemData"() {
    ...
    const messages: Message[] = await collectTestMessagesFromValidator(fileName, OpenApiTypes.arm, RequiredReadOnlySystemData)
  ...
  @test public async "all nested resources must have collection operation "() {
    ...
    const messages: Message[] = await collectTestMessagesFromValidator(fileName, OpenApiTypes.arm, NestedResourcesMustHaveListOperation)
  ...
  @test public async "operations api response must have specific schema"() {
    const fileName: string = "armResource/compute.json"
    const messages: Message[] = await collectTestMessagesFromValidator(fileName, OpenApiTypes.arm, OperationsApiResponseSchema)
  ...
  @test public async "top level resources must list by resource group"() {
    const fileName: string = "armResource/compute.json"
    const messages: Message[] = await collectTestMessagesFromValidator(fileName, OpenApiTypes.arm, TopLevelResourcesListByResourceGroup)
  ...
  @test public async "top level resources must list by subscription"() {
    const fileName: string = "armResource/compute.json"
    const messages: Message[] = await collectTestMessagesFromValidator(fileName, OpenApiTypes.arm, TopLevelResourcesListBySubscription)
  ...
  @test public async "get collection response schema should match the ARM specification "() {
    ...
    const messages: Message[] = await collectTestMessagesFromValidator(fileName, OpenApiTypes.arm, GetCollectionResponseSchema)
    assertValidationRuleCount(messages, GetCollectionResponseSchema, 1)
  }

  @test public async "all resources must have get operation"() {
    const fileName: string = "armResource/cdn.json"
    const messages: Message[] = await collectTestMessagesFromValidator(fileName, OpenApiTypes.arm, AllResourcesMustHaveGetOperation)
  ...
  @test public async "unique model name"() {
    ...
    const messages: Message[] = await collectTestMessagesFromValidator(fileName, OpenApiTypes.arm, UniqueModelName)
  ...
  @test public async "private link apis missing"() {
    ...
    const messages: Message[] = await collectTestMessagesFromValidator(fileName, OpenApiTypes.arm, ImplementPrivateEndpointAPIs)
  ...
  @test public async "private link resource schema unmatch"() {
    ...
    const messages: Message[] = await collectTestMessagesFromValidator(fileName, OpenApiTypes.arm, PrivateEndpointResourceSchemaValidation)
  ...
  @test public async "Unique x-ms-examples"() {
    ...
    const messages: Message[] = await collectTestMessagesFromValidator(fileName, OpenApiTypes.arm, UniqueXmsExample)
